...
기존 버전에서 사용중인 부분을 3.0.0으로 업그레이드시 옵션의 큰 변경은 없지만 차트의 기본적인 선의 두께나 타이틀의 위치, dot의 크기 등 많은 디자인이 변경되었기 때문에 주의해서 확인해야 될 부분이 있습니다.

이 문서에서는 차트별로 디자인이 변경된 부분과 새로운 버전으로 업그레이드시 주의 해야할 부분을 안내하겠습니다.
